...
namespace MToon
{
    public class MToonInspector : ShaderGUI
    {
        ...
        private MaterialProperty _colorOL;
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                EditorGUILayout.BeginVertical(GUI.skin.box);
                {
                    EditorGUILayout.LabelField("Texture", EditorStyles.boldLabel);
                    {
                        materialEditor.TexturePropertySingleLine(new GUIContent("Lit Color, Alpha", "Lit (RGB), Alpha (A)"),
                            _mainTex, _color, _colorOL);

                        materialEditor.TexturePropertySingleLine(new GUIContent("Blend texture", "using alpha"),
                            _mainTex2);
                ...
                EditorGUILayout.BeginVertical(GUI.skin.box);
                {
                    ...
                    EditorGUILayout.LabelField("Scale & Offset", EditorStyles.boldLabel);
                    {
                        ...
                        materialEditor.TextureScaleOffsetProperty(_mainTex2);
                    }
                    EditorGUILayout.Space();
