...
public class XXXXComponentExtension : IComponentExtension
{
	#region property
	...
	public XXXXComponentExtension()
	{
	}

	//TODO:[export] 记录其他属性值
	public XXXXComponentExtension(Test.XXXX x)
	{
		_Cutoff = x._Cutoff;
	}
	...
	{
		return new XXXXComponentExtension();
	}
	...
	{
		JToken token = extensionToken.Value[XXXXComponentExtensionFactory._Cutoff];
	...
	{
		(com as Test.XXXX)._Cutoff = _Cutoff;
	}
}
