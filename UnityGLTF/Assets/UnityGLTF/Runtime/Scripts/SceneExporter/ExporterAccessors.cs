...
public partial class GLTFSceneExporter
{
		...
		protected BinaryWriterWithLessAllocations _bufferWriter;
#else
	...
	private AccessorId ExportAccessorUint(Vector4[] arr)
		...
		protected AccessorId ExportAccessor(Matrix4x4[] arr)
		{
			exportAccessorMarker.Begin();
		...
		protected AccessorId ExportAccessor(float[] arr)
		{
			exportAccessorMarker.Begin();
		...
		protected AccessorId ExportAccessor(Color[] arr, bool exportAlphaChannel)
		{
			exportAccessorMarker.Begin();
