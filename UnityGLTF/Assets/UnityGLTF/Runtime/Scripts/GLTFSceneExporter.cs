...
namespace UnityGLTF
{
	...
	public partial class GLTFSceneExporter
	{
		...
		protected List<UniqueTexture> _textures;
		protected Dictionary<int, int> _exportedMaterials;
		...
		protected readonly Dictionary<UniquePrimitive, MeshId> _primOwner = new Dictionary<UniquePrimitive, MeshId>();

		#region Settings

		protected GLTFSettings settings => _exportOptions.settings;
		protected bool ExportNames => settings.ExportNames;
