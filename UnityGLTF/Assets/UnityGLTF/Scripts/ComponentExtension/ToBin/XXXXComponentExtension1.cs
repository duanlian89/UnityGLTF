...
public class XXXXComponentExtension1 : IByteComponentExtension
{
	...
	public XXXXComponentExtension1(UnityGLTF.GLTFSceneImporter importer)
	{
		this.importer = importer as ModelImporter1;
	}

	public XXXXComponentExtension1(UnityGLTF.GLTFSceneExporter exporter, Test.XXXX component)
	{
